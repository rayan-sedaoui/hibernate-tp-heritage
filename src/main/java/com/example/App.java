...
public class App {
    ...
    private static void testSingleTable(EntityManagerFactory emf) {
        ...
        try {
            ...
            List<Vehicule> vehicules = em.createQuery("SELECT v FROM Vehicule v", Vehicule.class).getResultList();
            ...
            List<Moto> motos = em.createQuery("SELECT m FROM Moto m", Moto.class).getResultList();
    ...
    private static void testJoined(EntityManagerFactory emf) {
        ...
        try {
            ...
            List<Developpeur> devs = em.createQuery("SELECT d FROM Developpeur d", Developpeur.class).getResultList();
    ...
    private static void testTablePerClass(EntityManagerFactory emf) {
        ...
        try {
            ...
            List<Electronique> elecs = em.createQuery("SELECT e FROM Electronique e", Electronique.class).getResultList();
