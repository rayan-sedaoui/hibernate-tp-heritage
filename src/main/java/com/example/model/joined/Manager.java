...
public class Manager extends Employe {
    ...
    public Integer getNombreSubordonnes() { return nombreSubordonnes; }
    public void setNombreSubordonnes(Integer nombreSubordonnes) { this.nombreSubordonnes = nombreSubordonnes; }
